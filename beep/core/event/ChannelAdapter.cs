/*
* ChannelAdapter.java  $Revision: 1.1 $ $Date: 2004/09/21 08:46:57 $
*
...
{
	/// <summary>This class provides a default nop implementation for each method
	/// in <code>ChannelListener</code>.</summary>
	/// <author>Huston Franklin</author>
	/// <version>$Revision: 1.1 $, $Date: 2004/09/21 08:46:57 $</version>
	public class ChannelAdapter : ChannelListener
	{
